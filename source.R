...
plt1 <- ggplot(df, aes(STATEID, ADM_RATE)) + geom_point() + ggtitle("State Identifier") + geom_smooth(method = 'lm', se = FALSE)
plt2 <- ggplot(df, aes(NUMBRANCH, ADM_RATE)) + geom_point() + ggtitle("Number of Branches") + geom_smooth(method = 'lm', se = FALSE)
plt3 <- ggplot(df, aes(CONTROL, ADM_RATE)) + geom_point() + ggtitle("Control Identifier") + geom_smooth(method = 'lm', se = FALSE)
plt4 <- ggplot(df, aes(HBCU, ADM_RATE)) + geom_point() + ggtitle("Historically Black-Serving Institute Identifier") + geom_smooth(method = 'lm', se = FALSE)
plt5 <- ggplot(df, aes(PBI, ADM_RATE)) + geom_point() + ggtitle("Predominantly Black-Serving Institute Identifier") + geom_smooth(method = 'lm', se = FALSE)
plt6 <- ggplot(df, aes(TRIBAL, ADM_RATE)) + geom_point() + ggtitle("Tribal-Serving Institute Identifier") + geom_smooth(method = 'lm', se = FALSE)
plt7 <- ggplot(df, aes(HSI, ADM_RATE)) + geom_point() + ggtitle("Hispanic-Serving Institute Identifier") + geom_smooth(method = 'lm', se = FALSE)
plt8 <- ggplot(df, aes(WOMENONLY, ADM_RATE)) + geom_point() + ggtitle("Women Only Institute Identifier") + geom_smooth(method = 'lm', se = FALSE)
...
plt12 <- ggplot(df, aes(REGION, ADM_RATE)) + geom_point() + ggtitle("Region") + geom_smooth(method = 'lm', se = FALSE)
plt1 + plt2 + plt3 + plt12 + plt4 + plt5 + plt6 + plt7 + plt8 + plt9 + plt10 + plt11
